...
useEffect(() => {
  const sorted = [...initialAvailabilities].sort(
  ...
  const onSubmit = (data: z.infer<typeof formSchema>) => {
    ...
    // Do NOT show toast here; show it in the parent after backend confirms update.
  };
                  ...
                  >
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                      <div className="flex items-center gap-4">
                        ...
                        />
                        <FormLabel htmlFor={`switch-${day}`} className="text-lg font-medium min-w-[100px]">{day}</FormLabel>
                      </div>
